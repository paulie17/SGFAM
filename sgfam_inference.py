...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_1", type=str, required=True, help="Path to the first input .npz descriptor file.")
    parser.add_argument("--input_2", type=str, required=True, help="Path to the second input .npz descriptor file.")
    parser.add_argument('--n_ev', type=int, default=50, help="Number of eigenvectors for functional map.")
    parser.add_argument('--simplify', action='store_true', help="Simplify mesh with point_cloud_utils watertight decimation.")
    parser.add_argument('--reduce_dim', action='store_true', help="Reduce descriptor dimensionality.")
    parser.add_argument('--target_dim', type=int, default=128, help="Target dimensionality for reduction.")
    parser.add_argument('--only_sem', action='store_true', help="Use only semantic descriptors.")
    parser.add_argument('--only_geom', action='store_true', help="Use only geometric descriptors.")
    parser.add_argument('--load_colors', action='store_true', help="Extract vertex colors from UV texture maps.")
    parser.add_argument('--save_emb_meshes', action='store_true', help="Save PLY meshes colored with functional map embeddings.")
    parser.add_argument('--output_directory', type=str, default="", help="Output directory for saved results.")
    parser.add_argument('--save_input_traj', action='store_true', help="Save source/input trajectory text file.")
    parser.add_argument('--save_target_traj', action='store_true', help="Save target trajectory text file.")
    parser.add_argument('--input_traj_path', type=str, default=None, help="Path to input trajectory text file.")
    parser.add_argument('--scale_input_traj', type=float, default=1.0, help="Scale factor for input trajectory.")
    ...
    parser.add_argument('--pca_type', type=str, choices=['kernel', 'linear'], default='kernel', help="PCA method: 'kernel' (Kernel PCA) or 'linear'.")
